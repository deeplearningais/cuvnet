...
namespace cuvnet
{
     ...
     * Response Norm across maps.
     *
     * @ingroup CudaConvnetOps  //TODO: is this right?
     */
    class ResponseNormalizationAcrossMapsNCHW
        : public Op{
            public:
                typedef Op::value_type    value_type;
                typedef Op::op_ptr        op_ptr;
            ...
            private:
                ...
                matrix m_denom;
            public:
                ResponseNormalizationAcrossMapsNCHW() :Op(1,1){} ///< for serialization
                 ...
                 * @param pow_scale raise denominator to this power
                 */
                ResponseNormalizationAcrossMapsNCHW(result_t& images, int group_size, float add_scale, float pow_scale)
                    :Op(1,1),  //TODO: blocked?
                    m_group_size(group_size),
                    m_add_scale(add_scale),
                    m_pow_scale(pow_scale)
