...
namespace cuvnet
{
    namespace models
    {
        void logistic_regression::reset_params(const std::string& stage){
            if(m_W)
        ...
        logistic_regression::op_ptr logistic_regression::loss(const std::string& stage)const{ return m_loss; }
        logistic_regression::op_ptr logistic_regression::error(const std::string& stage)const{ return m_classloss; }
        ...
        std::vector<Op*> logistic_regression::get_params(const std::string& stage){
