...
BOOST_PYTHON_MODULE(_pycuvnet)
{
    ...
    class_<models::conv_layer_opts>("conv_layer_opts")
        ...
        //.def("pool", &models::conv_layer_opts::pool, (args("pool_size")=2, args("pool_stride")=-1, args("pt")=cuv::alex_conv::PT_MAX), return_internal_reference<>())
        .def("pool", &conv_layer_opts_pool, (args("pool_size")=2, args("pool_stride")=-1, args("pt")=(int)cuv::alex_conv::PT_MAX), return_internal_reference<>())
