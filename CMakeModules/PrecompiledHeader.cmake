...
MACRO(ADD_PRECOMPILED_HEADER _targetName _input)
  ...
  IF(CMAKE_COMPILER_IS_GNUCXX)
    ...
    MESSAGE("${CMAKE_CXX_COMPILER} -DPCHCOMPILE ${_compiler_FLAGS} -std=c++0x -x c++-header -o {_output} ${_source}")
    ADD_CUSTOM_COMMAND(
      OUTPUT ${_output}
      COMMAND ${CMAKE_CXX_COMPILER} ${_compiler_FLAGS} -std=c++0x -x c++-header -o ${_output} ${_source}
      DEPENDS ${_source} )
